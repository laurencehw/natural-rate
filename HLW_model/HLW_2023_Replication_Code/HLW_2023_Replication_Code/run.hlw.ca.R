...
ca.data <- read.xlsx("inputData/Holston_Laubach_Williams_estimates.xlsx", sheet="CA input data",
...
# Save output to CSV
write.table(output.ca, 'output/output.ca.csv', col.names=TRUE, quote=FALSE, row.names=FALSE, sep = ',', na = '')
